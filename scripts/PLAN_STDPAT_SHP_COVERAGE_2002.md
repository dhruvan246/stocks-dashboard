...
| P1 1999-2001 | **PARTIAL → +238 +6 +12 = 256 (runbook §134/§134e, BSE archived results page: anchored, cumdiff, cross-anchored; 1,587 roots left unanchored)** | MC E2b 766 cells 1999-2001 (+ 11 WB 2001); residue by tag in `stdpat_2002_residue_2026-09-05.json`'s method (those years not in the file — regenerate with the §6 recipe) | `agg_pat_cell_fills.json` applied `2026-09-05` |
