...
const CACHE = 'sw-shell-v78';   // v78: results announced date (All Results header, modal row, stock-page column) + backtest drawdown chart (v77: Season Trends caption fix)
const SHELL = [
