...
const CACHE = 'sw-shell-v87';   // v87: membership clamp — lastSnap no longer floors to the earliest snapshot (v86: FUND_ALIAS += BILT->BALLARPUR, SUNCLAYTON->TVSHLTD §93 era orphans)
const SHELL = [
