...
const SHELL = [
  ...
  './theme.css', './theme.js', './glossary.js', './bt-names.js', './backtest-engine.js', './live-perf.js', './bt-sync.js', './sw-sync.js', './sw-watchlist.js',
