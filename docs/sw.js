...
const CACHE = 'sw-shell-v78';   // v78: results announced date — All Results header "Announced", company-modal Announced row, stock-page Announced column (v77: Season Trends caption fix)
const SHELL = [
