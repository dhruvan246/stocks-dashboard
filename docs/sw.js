...
const CACHE = 'sw-shell-v98';   // v98: stock.html — ann=0 is "date unknown": no more cx="NaN" circle, no "0--" date, no rewind look-ahead (v97: Coverage Matrix ↻ Refresh + ⚙ Re-run bake controls (v96: 'conOnly' measurement basis in both engine twins (coverage matrix; inert for strategies) (v95: .tscroll — long tables scroll in place under a pinned header (v94: shareholding %% shown at 4dp (§22j) )
const SHELL = [
