...
window.SW_GLOSSARY = (function () {
  ...
  var T = {
    ...
    accel3m:    ['accel3m', "<b>3-month momentum acceleration</b>. The last 3-month return minus the 3-month return before it (calendar 91-day windows), in percentage points. Positive = the 3-month trend is speeding up."],
    ...
    dma50:      ['dma50', "<b>Distance from the 50-DMA %</b> — how far above (+) or below (−) the average close of the last 50 trading sessions the price sits (sessions, not calendar days — changed 2026-09-02)."],
    dma200:     ['dma200', "<b>Distance from the 200-DMA %</b> — the same, against the 200-session average. The 200-DMA is the usual dividing line between a long-term uptrend and a downtrend."],
    ...
    consol:     ['Consolidated vs Standalone', "<b>Consolidated</b> accounts include every subsidiary; <b>standalone</b> is the parent company alone. This site shows consolidated by default (a stock page lets you switch to standalone), and a quarter marked <b>mix</b> is consolidated for the figures the company filed that way and standalone for the rest. Growth always compares both periods on the <i>same</i> basis, because mixing the two invents growth that never happened."],
  ...
  var P = {
    ...
    'stock-backtest.html': {
      ...
      secs: [
        ...
        ['Price & momentum factors', ['ret1m', 'ret3m', 'ret6m', 'ret12m', 'accel', 'accel3m', 'riskmom', 'postdrift', 'composite']],
